...
const LegalLayout = ({ title, subtitle, children }) => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* CONTENT */}
      <main className="max-w-5xl mx-auto w-full px-6 py-10 space-y-6 flex-1">
        {children}
      </main>

      {/* FOOTER */}
      <footer className="border-t bg-card mt-10">
        <div className="max-w-5xl mx-auto px-6 py-6 text-sm text-muted-foreground text-center">
