            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="mt-12 border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61591137336427"
                            target="_blank"
                        ...
                        <a href="https://x.com/GrowMatrixtbiz"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-muted-foreground hover:text-primary transition">
                            <FaTwitter size={18} />
                        ...
                        <a href="https://www.linkedin.com/in/grow-matrix-145030419/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-muted-foreground hover:text-primary transition">
                            <FaLinkedin size={18} />
                        ...
                        <a href="https://www.youtube.com/@GrowMatrix-l3r"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-muted-foreground hover:text-primary transition">
                            <FaYoutube size={18} />
